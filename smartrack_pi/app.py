...
def main():
    ...
    st.markdown(f'<a class="big-font" href="{link}" target="_self">Go To Companion</a>', unsafe_allow_html=True)
    ...
    with st.form(key="my-form"):
        ...
        mask = st.text_input("Enter the subnet mask (Click the Arrow in the Top Left for Bit Mask Calculator)", value=mask)
