...
```shell
sudo nano /home/pi/OLED_display
```
...
If you like to use this display script but prefer to run it in a container, you first need to make sure you have Docker installed and running, aswell as have I2C enabled correctly:
...
But if you like to use a different one like `status.py`, you can do it with the below command
