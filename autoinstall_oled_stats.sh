...
show_version() {
    echo "OLED Stats Display Installation Script"
    echo "Version: $SCRIPT_VERSION"
    echo "Script Author: $SCRIPT_AUTHOR"
    echo "Original OLED Stats Code: $ORIGINAL_AUTHOR"
    echo "Repository: https://github.com/4ngel2769/rpi_oled_stats"
    echo "Original Code: https://github.com/mklements/OLED_Stats"
    echo ""
    echo "This script automates the installation of OLED Stats Display"
    echo "for Raspberry Pi running Raspberry Pi OS Bookworm."
    echo ""
    echo "Credits:"
    echo "- Installation script by $SCRIPT_AUTHOR"
    echo "- Original OLED Stats implementation by $ORIGINAL_AUTHOR"
    exit 0
}

# Function to show help information
show_help() {
    echo "OLED Stats Display Installation Script $SCRIPT_VERSION"
    echo "Script Author: $SCRIPT_AUTHOR"
    echo "Original Code: $ORIGINAL_AUTHOR"
    echo ""
    echo "Usage: curl -fsSL https://raw.githubusercontent.com/4ngel2769/rpi_oled_stats/refs/heads/main/autoinstall_oled_stats.sh | bash [OPTIONS]"
    echo ""
    echo "Options:"
    ...
    echo "  curl -fsSL https://raw.githubusercontent.com/4ngel2769/rpi_oled_stats/refs/heads/main/autoinstall_oled_stats.sh | bash"
    echo ""
    echo "  # Verbose installation"
    echo "  curl -fsSL https://raw.githubusercontent.com/4ngel2769/rpi_oled_stats/refs/heads/main/autoinstall_oled_stats.sh | bash -s -- --verbose"
    echo ""
    exit 0
}
...
print_version_info() {
    echo -e "${MAGENTA}[VERSION]${NC} OLED Stats Installation Script $SCRIPT_VERSION by $SCRIPT_AUTHOR"
    echo -e "${MAGENTA}[CREDITS]${NC} Original OLED Stats code by $ORIGINAL_AUTHOR"
}
...
EOF
    ...
    echo "✓ Installation script by: $SCRIPT_AUTHOR"
    echo "✓ Original OLED Stats code by: $ORIGINAL_AUTHOR"
    echo "✓ System updated"
    ...
    echo ""
    echo "CREDITS:"
    echo "Installation script: $SCRIPT_AUTHOR"
    echo "Original OLED Stats: $ORIGINAL_AUTHOR"
    echo ""
